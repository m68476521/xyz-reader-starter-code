...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ni == null || !ni.isConnected()) {
            Snackbar snackbar = Snackbar.make(findViewById(R.id.coordinator_layout),
                    R.string.msg_no_internet, Snackbar.LENGTH_LONG);
            TextView view =  snackbar.getView().findViewById(android.support.design.R.id.snackbar_text);
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ArticleListActivity.Adapter adapter = new ArticleListActivity.Adapter(ArticleListActivity.this, cursor);
    ...
    private class Adapter extends RecyclerView.Adapter<ArticleListActivity.ViewHolder> {
        ...
        @Override
        public ArticleListActivity.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(final ArticleListActivity.ViewHolder holder, final int position) {
            mCursor.moveToPosition(position);
